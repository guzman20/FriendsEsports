...
VALUES ( 'a@a.com', '2020-25-9', 'a', '$2a$10$C7bYDLtja1vQARJuz798luHjiOoCaDTpgMxUFYdL/lHq2onyaL7gu');
INSERT INTO FriendEsports.usuario (  email, fecha_nacimiento, nombre, password_usuario) 
VALUES ( 'b@b.com', '2020-25-9', 'b', '$2a$10$C7bYDLtja1vQARJuz798luHjiOoCaDTpgMxUFYdL/lHq2onyaL7gu');
...
INSERT INTO FriendEsports.conversacion (juego, titulo, texto,id_usuario,fecha_de_creacion) VALUES ('lol','Anivia, la criofenix','Mi campeón favorito, sin duda alguna Anivia, la criofenix. No tendrá mucho ataque, no tendrá mucha defensa... pero me encanta. Es muy difícil de controlar, sobre todo la Q, porque tienes que petarla y controlar la distancia muy bien para stunear.','1','2021-06-16 18:31:44.813730');
INSERT INTO FriendEsports.conversacion (juego, titulo, texto,id_usuario,fecha_de_creacion) VALUES ('valorant','Os juro, Como oiga a alguien decir otra vez que no se puede hacer counter a Viper despues de plantar ','1) Pushea bro?
